...
<p align="center">
  <img src="../screenshots/builtin-llm/12-全平台熔断时的中文引导.png" alt="全平台熔断时的中文引导" width="760" />
</p>
<p align="center">
  <img src="../screenshots/builtin-llm/13-内置额度整体停用时的中文引导.png" alt="内置额度整体停用时的中文引导" width="760" />
</p>
...
| 现象 | 多半是 | 怎么办 |
|---|---|---|
| 侧栏写着「Hunter key 已配置」,对话框里却还是自己的模型(如 `deepseek-flash`) | 侧栏那把 key 只管工具与数据源,**不会自动切换大模型** | 点侧栏「Hunter key 已配置 · 管理」→「一键开启内置额度」;或重跑向导选第一张卡。弹窗说「配置写在 .env 里」的,按第六节改 `.env` |
