...
### 🆕 官方 MCP 支持进展(2026-09-13 更新)

**当前立场:hunter-community 不预置任何具体金融数据厂商的 MCP 集成,等我们与官方逐一沟通并拿到正式授权后再开放。**

**同花顺(HiThink)· 待官方合作确认**

- 我们注意到同花顺已在其官方文档站列出 `fuyao.aicubes.cn/mcp/*` 系列 MCP 端点,允许开发者自助申请 API Key 使用
- **但目前尚未获得同花顺官方对 hunter-community 作为集成方的书面授权** —— 出于合规考虑,我们不预置该数据源
- 我们正在与同花顺官方联系,**期待建立正式合作关系** · 拿到授权后将支持用户自持 key 接入

**通达信(Tongdaxin)· 待官方开放 MCP 接入文档**

- 通达信也有 MCP 服务 · 但**官方目前没有对外公开授权的 API 地址与开发者文档**
- 出于合规考虑,hunter-community **不集成任何未公开授权的通达信接口**
- 我们正在与通达信官方沟通 · **期待他们能支持我们的开源产品** —— 让已购买付费 key 的用户 · 能正常把通达信 MCP 接入 hunter-community 使用

**目前用户可以使用的数据源**:免费开源源(akshare / yfinance)+ 用户自持第三方 MCP(通用 MCP 接入,不预置任何具体厂商)。同花顺、通达信、其他数据商的官方集成 · 等我们逐一沟通拿到授权后陆续加入。
