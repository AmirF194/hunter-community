...
_V1 = {
    ...
    "breakout": ("突破买入 v6 —— 入场同 v4(密集成交区枢轴、RS ≥ 70、10 日量 < 50 日量、1 月振幅 ≤ 15%)+ 两次加仓;"
                 "出场:初始止损取 Base 低点下方 1.5% 与 1.5 ATR 较宽者(≤ 7%)+ 5% 保本 + 20% 减半 + 破 EMA10 再减半 / 破 EMA20 清仓;"
                 "去掉固定 6% 与 Base 低点 2% 止损",
