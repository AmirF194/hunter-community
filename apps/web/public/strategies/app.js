...
function kcLegend(rows, mark) {
  ...
  // 筛选器:扫描当日按结果表补标 / 自家日线没有这只票等说明,常驻显示(不藏 title 里)
  if (mark.noteShow && !mark.unknown) {
    parts.push('<span class="kc-note" style="color:var(--muted,#8a8378)">' + kcEsc(mark.noteShow) + '</span>')
  }
